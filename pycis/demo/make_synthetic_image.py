...
cam_noise = 2.5
camera = pycis.Camera(bit_depth, sensor_format, pixel_size, qe, epercount, cam_noise, polarised=True)

optics = [17e-3, 105e-3, 150e-3, ]

interferometer_orientation = 0
pol_1 = pycis.LinearPolariser(0 + interferometer_orientation)
wp_1 = pycis.UniaxialCrystal(np.pi / 4 + interferometer_orientation, 10e-3, 0, )
qwp = pycis.QuarterWaveplate(np.pi / 2 + interferometer_orientation, )
pol_2 = pycis.LinearPolariser(0 + interferometer_orientation)
