...
cam_noise = 2.5
camera = pycis.PolarisedCamera(bit_depth, sensor_format, pixel_size, qe, epercount, cam_noise)
...
interferometer = [pol_1, wp_1, qwp, pol_2]
...
spec = xr.open_dataarray(fpath_spec, chunks={'x': 100, 'y': 100, })
